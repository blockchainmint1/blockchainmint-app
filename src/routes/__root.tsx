...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Verify, watch, receive into, and sweep your physical Cold Storage Coins. Part of the honest.money ecosystem." },
      { name: "author", content: "Blockchain Mint" },
      { property: "og:title", content: "Blockchain Mint — Cold Storage Coins" },
      { property: "og:description", content: "Verify, watch, receive into, and sweep your physical Cold Storage Coins. Part of the honest.money ecosystem." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Blockchain Mint — Cold Storage Coins" },
      { name: "twitter:description", content: "Verify, watch, receive into, and sweep your physical Cold Storage Coins. Part of the honest.money ecosystem." },
